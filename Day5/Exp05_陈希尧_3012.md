...
调节参数η对EG和ONS这两种基于资本增长理论的算法影响如下
...
综上进行分析，当η较小时，算法效果趋近于EW策略，当η不断增大算法效果趋向于Best策略，这从weight图和结果都可以看出

虽然提高η可以有效提高财富总量，但是同样的，资产的波动性不断上升，表明这种投资组合方式的风险对应上升，与我们最初规避风险的初衷不符合，因此η不宜选取过大
